...
function SocialMedia({ href, icon }: socialMediaProps) {
    return (
      <Link
        className=" w-8 text-sm text-[#616466] rounded-full "
        href={href}
      >
...
function Footer(){
    return(
        <footer className="flex flex-col gap-8 items-center w-full bg-[#F6F6F6] py-10 my-10 text-xs">
            <div className="flex w-full justify-around flex-wrap">
                <div className="p-4">
                    <ul className="space-y-3">
                        <li className="font-medium pb-4">For Marketers</li>
                        <li>Courses & Tasks</li>
                ...
                <div className="p-4">
                <ul className="space-y-3">
                        <li className="font-medium pb-4">For Business</li>
                        <li>Tasks</li>
                        <li>Apprenticeships</li>
                    </ul>
                </div>
                ...
                <div className="p-4">
                    <ul className="space-y-3">
                        <li className="font-medium pb-4">Free Marketing Courses</li>
                ...
                <div className="p-4">
                    <ul className="space-y-3">
                        <li className="font-medium pb-4">Aramada</li>
                        <li>About</li>
                        <li>Careers</li>
            ...
            <div className="border w-3/4 border-[#E4E5E6]"></div>
